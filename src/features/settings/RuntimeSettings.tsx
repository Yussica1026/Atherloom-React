...
export function RuntimeSettings(props: RuntimeSettingsProps) {
  ...
  return <section className="settings-section settings-feature">
    ...
    <div className="settings-edit-card runtime-diagnostic"><h4>版本与运行方式</h4><p>Atherloom React 0.2.7 · Android versionCode 14</p><p>{window.AtherloomNative ? "Android WebView 本机/后端双模式" : "浏览器 / 可安装 PWA；离线壳不会强制刷新正在进行的聊天。"}</p></div>
